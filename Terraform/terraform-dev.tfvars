...
instance_info = [
    ...
    {instance_name = "ins-dev-ecs-1" , host_name = "node1", private_ip = "192.168.4.11"},
    {instance_name = "ins-dev-ecs-2" , host_name = "node2", private_ip = "192.168.4.12"},
    {instance_name = "ins-dev-ecs-3" , host_name = "node3", private_ip = "192.168.4.13"}    
]